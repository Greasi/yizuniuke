			...
			<div class="tiles">
				<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>智能专项练习标题列表
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
                                                            ...
                                                            <div class="btn-group">
									<a href="<?=SITE_URL?>question/add_ti">
									<button id="sample_editable_1_new" class="btn green">
									添加题 <i class="fa fa-plus"></i>
									</button></a>
								</div>
                                                            <div class="btn-group">
                                                                <select id="gai">
                                                                    <?php foreach($arr as $vv){ ?>
                                                                    <option value="<?php echo $vv['_id']?>"><?php echo $vv['title']?></option>
                                                                     <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
							...
							<tr class="odd gradeX">
								...
								<td width="410">
									<a href="mailto:shuxer@gmail.com">
									 ...
									 <?php echo $v['type'] ?>
                                                                ...
                                                                <td>
									 <?php echo $v['all_answer'] ?>
								</td>
                                                                <td>
									 <?php echo $v['really_answer'] ?>
								</td>
                                                                <td>
                                                                    <?php foreach($arr as $vv){ ?>
                                                                        <?php if($v['pid']==$vv['_id']){ 
								...
								<td>
									<span>
                                                                            <a href='<?=SITE_URL?>company/delete&id=<?= $v['_id'] ?>' class='label label-sm label-success'>删除</a> 
									</span>
	...
	<!-- END CONTENT -->
                                    ...
                                    <script type="text/javascript">
                                        $('#gai').change(function(){
                                           ...
                                           //alert(id);
                                           $.ajax({
                                               url:"<?=SITE_URL?>question/ti_sousuo",
                                                type:"get",
                                                dataType:"json",
                                                data:{"id":id},
                                                success:function(obj){
                                                    alert(obj.page)
                                                    $('#tihuan').html(obj.content)
                                                    $('#page').html(obj.page)
                                                }
                                            });
                                        });
