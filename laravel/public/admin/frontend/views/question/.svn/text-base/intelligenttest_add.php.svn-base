		...
		<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?=SITE_URL?>question/intelligenttest_doadd" method='post' class="form-horizontal form-bordered">
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">标题名称</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="title" id="maxlength_defaultconfig">
