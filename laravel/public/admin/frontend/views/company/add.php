		...
		<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?=SITE_URL?>company/doadd" method='post' class="form-horizontal form-bordered">
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">公司名称</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="c_name" id="maxlength_defaultconfig">
											
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">是否前台显示</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="1" name="c_show" id="maxlength_thresholdconfig">
											
										</div>
									</div>
									
									<div class="form-group">
										<label class="control-label col-md-3">公司描述</label>
										<div class="col-md-9">
											<textarea name='c_desc' id="maxlength_textarea" class="form-control" maxlength="225" rows="2" placeholder="This textarea has a limit of 225 chars."></textarea>
										</div>
									</div>
