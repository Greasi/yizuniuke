		...
		<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>后台用户添加
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?=SITE_URL?>user/doadd" method='post' class="form-horizontal form-bordered">
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">用户名</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="username" id="maxlength_defaultconfig">
										...
										<div class="col-md-4">
											<input type="password" class="form-control" maxlength="25" name="password" id="maxlength_defaultconfig">
